...
//Добавить на страницу 3элемента из шаблона

let templateElement = document.querySelector("#element-template").content;


let itemsParent = document.querySelector('.items');

for(let i= 0; i<3; i++){
  let  template = templateElement.cloneNode(true);
  template.querySelector(".el span").textContent="123";
  itemsParent.appendChild(template);
}
